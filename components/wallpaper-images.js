    ...
    return (     
        <div key={`wallpaper_${key}`} className="rounded-lg shadow-lg bg-white mb-10">
          <a href="#!">             
            ...
            width={wallpaper?.wallpaper?.mediaDetails?.width || 2000}
            height={wallpaper?.wallpaper?.mediaDetails?.height || 2000}     
            layout="raw"
          ...
          <div className="p-6 flex justify-between justify-items-center">
            <div>
            <h2 className="text-gray-900 text-xl font-medium mb-2 pr-2">Card title</h2>
